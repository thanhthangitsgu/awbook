...
const PositionPage = () => {
    ...
    useEffect(() => {
        dispatch(allAPI.positionAPI.getAll());
    }, []);

    //Lấy danh sách vào list

    useEffect(() => {
        positionReducer.data && positionReducer.data.data && setlistPosition(positionReducer.data.data);
    }, [positionReducer])
    ...
    useEffect(() => {
        ...
        data = filter != "" ? data.filter(item => item.name.includes(filter)) : listPosition;
            ...
            <div className="page-admin-content">
                ...
                <div className="bodyadmin">
                    <table className="table">
                        ...
                        <tbody>
                            {dataPosition.length > 0 && dataPosition.map((element, index) => {
                                return (
                                    <tr className={index % 2 ? "row-ood" : "row-even"} key={index}>
                                        ...
                                        <td className="col-last">
                                            <div className="action">
                                                <Link to={'/admin/chuc-vu/' + element.id}><button className="btn-detail" >
