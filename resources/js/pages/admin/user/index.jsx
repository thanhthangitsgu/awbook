...
const UserPage = () => {
    ...
    useEffect(() => {
        ...
        data = filterPosition == 0 ? data : data.filter(item => item.position_id == filterPosition);
        data != [] && setlistUser(data);
    }, [userReducer, filterPosition])
    useEffect(() => {
    ...
    useEffect(() => {
        let data = listUser;
        data = filter != "" ? data.filter(item => item.name.includes(filter)) : listUser;
        setdataUser(data);
    }, [filter])
            ...
            <div className="page-admin-content">
                <div className="header">
                    ...
                    <div className="button-filter">
                        <select name="" id="" onChange={() => handleFilterPosition(event)}>
