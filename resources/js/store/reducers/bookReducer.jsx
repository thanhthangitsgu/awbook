...
const bookReducer = (state = initState, action) => {
    ...
    switch (action.type) {
        ...
        case 'book/getListBookTitle':
            let temp = action.payload;
            return { ...state, listBookTitle: temp }
        case 'book/addBookTitle':
            let temp_ = action.payload;
            return { ...state, message: temp_ }
        case 'book/deleteBookTitle':
